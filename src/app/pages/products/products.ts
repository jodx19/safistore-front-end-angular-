    ...
    this.productService.getAllProducts({
      ...
      next: (response: any) => {
        ...
        this.products = items.map((p: any) => ({
          ...
          image: p.image || p.imageUrl || 'https://placehold.co/400x300/1a1a2e/a78bfa?text=SafiStore',
          thumbnail: p.thumbnail || p.imageUrl || 'https://placehold.co/400x300/1a1a2e/a78bfa?text=SafiStore',
          rating: p.rating || 0,
